...
def on_send_success(record_metadata, result):
    result['success'] = True
    result['info'] = "Successfully send message to topic {}, partition {}, offset {}".\
...
def register():
    ...
    msg_new_employee = MSG_NEW_EMPLOYEE.format(number=number, name=name, department=department).encode()
